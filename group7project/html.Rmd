...
* **table_betas** the vector of coefficient whose length is the same as `response` such that `response = predictor%*%betas`

* **tab_ci** the table of confidence intervals for `Beta`
